...
$("#_comic").innerHTML+="<div onclick=\"document.querySelector('#nextBook').querySelector('a').click();\" style=\"width:100vw;height:10vh; background:#607D8B;color:white;font-size:3vh;line-height:10vh;text-align:center;\">下一章</div>";
//菜单开关
var menu=true;
...
document.querySelector("#prevBook").querySelector("a").click();
});
$("#_menu td",2).on("click", function (){
document.querySelector(".hd[title='下章']").click();
});
}
